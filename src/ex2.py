...
def name_surname(df):
    ...
    # Generamos nombres aleatorios para cada fila
...
def clean_dataset(df):
    ...
    """
    # Filtramos registros donde el tiempo no sea '00:00:00'
...
def get_cyclist_info(df, dorsal):
    """
    Recuperamos los datos del ciclista con un dorsal específico
    """
